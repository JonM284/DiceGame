...
namespace Runtime.GameControllers
{
    public class UIController: GameControllerBase
    {
        ...
        public void CreateFloatingTextAtPosition(string _displayString, Color _color, Vector3 _position)
        {
            ...
            var newPopupTextObject = Instantiate(textAssetRef, _position, Quaternion.identity);
            ...
            _textItem.transform.position = _position;
        ...
        private void CacheTextPopup(PopupTextItem _textItem){
            ...
            _textItem.transform.ResetTransform(cachedPopupTextPool);
        }
